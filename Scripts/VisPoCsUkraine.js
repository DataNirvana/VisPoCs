...
function DrawResponsively() {
    ...
    if (responsiveMode === 1) {
        ...
        DCO["GR"] = [260, 0, 330, 300]; // Region of origin
        DCO["CP"] = [260, 310, 330, 400]; // Country of origin

        DCO["CO"] = [600, 0, 1120, 710]; // Map - in this case we draw it ...
        ...
        DCO["GR"] = [10, 105, 330, 300]; // Region of origin
        DCO["CP"] = [10, 415, 330, 230]; // Country of origin

        DCO["CO"] = [350, 105, 1120, 540]; // Map - in this case we draw it ...
        ...
        DCO["GR"] = [xCol3L, 0, colWidth, 335]; // Region of origin
        DCO["CP"] = [xCol3L, 345, colWidth, 250]; // Country of origin

        DCO["CO"] = [10, 605, tripleColWidth, 640]; // Map - in this case we draw it ...
        ...
        DCO["GR"] = [10, 345, colWidth, 300]; // Region of origin
        DCO["CP"] = [xCol2L, 345, colWidth, 300]; // Country of origin

        DCO["CO"] = [10, 915, doubleColWidth, 640]; // Map - in this case we draw it ...
        ...
        DCO["GR"] = [5, 615, colWidth, 300]; // Region of origin
        DCO["CP"] = [5, 925, colWidth, 230]; // Country of origin

        DCO["CO"] = [5, 1425, colWidth, 640]; // Map - in this case we draw it ...
...
function VisualiseData() {
    ...
    //--CHART-05-- Do a map CO    
    let mapGraphic = new DNChart();
    mapGraphic.Map("CO", null, "DataVis", chartGroup, DCO["CO"][0], DCO["CO"][1], DCO["CO"][2], DCO["CO"][3], ListCO, null, "Country of origin",
    ...
    // Draw the map
    mapGraphic.DrawMap(chartGroup.GetInfoIDNumericKey("CO"), chartGroup.GetInfoIDNumericKey(null));
